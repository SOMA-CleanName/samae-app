      ...
      {allRead ? (
        ...
        >
          <fieldset className="rounded-2xl border border-line p-5">
            ...
            <div className="mt-1 flex flex-col gap-4">
              ...
              {/* 정산 계좌 — 여기서 받는다.
                  ...
                  막힌다. 정산 기한이 7영업일(수수료·정산 정책 3조 2항)이라 그때 가서 받기 시작하면
          ...
          {/* ⚠️ 홍보 사용은 **여기서 일괄로 받지 않는다.**
              ...
              근거는 **작가 입점 계약 제7조 1항**이다(작가 이용약관 제14조 4항이 "범위와 조건은
              입점 계약에서 정한다" 고 넘긴다). 그 계약 문안도 한동안 "입점 동의 화면에서
              동의한다" 로 남아 있어 이 화면과 어긋나 있었고, 2026-09-17 에 사진별로 고쳤다
              (계약 1.1). — 전에 이 주석이 근거로 든 "작가약관 제20조 3항" 은 회사의 면책 조항이다. */}
          <fieldset className="rounded-2xl border border-line p-5">
