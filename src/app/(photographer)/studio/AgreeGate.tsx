...
// 입점 동의 — 승인된 작가가 스튜디오에 처음 들어올 때, 그리고 문서 버전이 올라갈 때 뜬다.
//
// 작가약관 4조 2항: "입점 동의 화면에서 정보를 입력하고 동의한 때에 이용계약이 성립하며,
//               동의일부터 작가로 활동할 수 있다."
//
// ⚠️ **전에는 체크박스 네 개와 [모두 동의] 버튼이었다.** 문서 링크는 새 탭으로 나갔고,
//    열었는지조차 보지 않았다. 문서를 **한 번도 안 열고 통과할 수 있었다.**
...
//    ③ 정보   — 문서를 다 읽은 뒤에만 열리는 계약 당사자 정보란
//
      ...
      <section className="mt-8 rounded-2xl bg-surface-2 p-5">
        ...
        <ul className="mt-3 flex flex-col gap-2.5">
          {[
            ...
            "정산은 결과물을 전달하고 서비스에서 전달 완료를 누른 뒤에 해요. 확인된 날부터 7영업일 안에 보내드려요.",
      ...
      {allRead ? (
        ...
        >
          ...
          {/* ⚠️ 홍보 사용은 **여기서 일괄로 받지 않는다.**
              ...
              근거는 **작가 이용약관 제20조 3항**("홍보 사용 허용은 사진별로 선택하며")과
              **작가 입점 동의서 제4항**이다 — 2026-09-15 묶음에서 두 문서가 같은 말을 하도록
              맞췄다. 그 전에는 계약 문안만 "입점 동의 화면에서 동의한다" 로 남아 이 화면과
              어긋나 있었다(2026-09-17 에 사진별로 교정). */}
          <fieldset className="rounded-2xl border border-line p-5">
