...
/*
  ...
  ⚠️ 제1항에서 **생년월일과 이메일을 뺐다**(2026-09-18 정본 개정). 생년월일은 폐기된
     원천징수 모델의 잔재였다 — 화면도 DB 도 그런 걸 받은 적이 없는데 문서만 "세무 처리용" 으로
     받는다고 적고 있었다(우리는 지급자가 아니라 원천징수를 하지 않는다, 2026-09-16 126 상담).
     **안 받는 걸 받는다고 적어 두면 그 자체가 수집 근거가 된다.** 이메일도 이 화면이 아니라
     가입에서 받으므로 여기 목록에 둘 자리가 아니다.
*/
